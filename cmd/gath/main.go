...
import (
	...
	"github.com/forgetopchain/go-forgetop/cmd/utils"
	"github.com/forgetopchain/go-forgetop/common"
	"github.com/forgetopchain/go-forgetop/console"
	"github.com/forgetopchain/go-forgetop/contracts/release"
	"github.com/forgetopchain/go-forgetop/eth"
	"github.com/forgetopchain/go-forgetop/ethclient"
	"github.com/forgetopchain/go-forgetop/internal/debug"
...
var (
	...
	app = utils.NewApp(gitCommit, "the go-forgetop command line interface")
)
...
func init() {
	...
	app.Copyright = "Copyright 2013-2018 The go-forgetop Authors"
...
func startNode(ctx *cli.Context, stack *node.Node) {
	...
	if ctx.GlobalBool(utils.MiningEnabledFlag.Name) {
		...
		if err := stack.Service(&ethereum); err != nil {
			utils.Fatalf("forgetop service not running: %v", err)
		}
