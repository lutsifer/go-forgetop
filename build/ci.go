...
import (
	...
	"github.com/forgetopchain/go-forgetop/internal/build"
)
...
var (
	...
	debExecutables = []debExecutable{
		{
			Name:        "gath",
			Description: "forgetop CLI client.",
		},
		{
			Name:        "rlpdump",
...
func doArchive(cmdline []string) {
	...
	var (
		...
		gath     = "gath-" + base + ext
		alltools = "gath-alltools-" + base + ext
	)
	...
	for _, archive := range []string{gath, alltools} {
...
type debMetadata struct {
	...
	// go-forgetop version being built. Note that this
...
func newDebMetadata(distro, author string, env build.Environment, t time.Time) debMetadata {
	if author == "" {
		...
		author = "forgetop Builds <fjl@ethereum.org>"
	}
	return debMetadata{
		Env:         env,
		Author:      author,
...
func doWindowsInstaller(cmdline []string) {
	...
	*workdir = makeWorkdir(*workdir)
	...
	installer, _ := filepath.Abs("gath-" + archiveBasename(*arch, env) + ".exe")
...
func doAndroidArchive(cmdline []string) {
	...
	build.MustRun(gomobileTool("bind", "--target", "android", "--javapkg", "org.ethereum", "-v", "github.com/forgetopchain/go-forgetop/mobile"))
	...
	archive := "gath-" + archiveBasename("android", env) + ".aar"
...
func doXCodeFramework(cmdline []string) {
	...
	bind := gomobileTool("bind", "--target", "ios", "--tags", "ios", "-v", "github.com/forgetopchain/go-forgetop/mobile")
	...
	archive := "gath-" + archiveBasename("ios", env)
