...
import (
	...
	"github.com/forgetopchain/go-forgetop/eth/fetcher"
...
func (pm *ProtocolManager) Stop() {
	glog.V(logger.Info).Infoln("Stopping forgetop protocol handler...")
	...
	glog.V(logger.Info).Infoln("forgetop protocol handler stopped")
}
