...
[![Build
Status](https://travis-ci.org/forgetop/go-forgetop.png?branch=master)](https://travis-ci.org/forgetop/go-forgetop)

The common package contains the ethereum utility library.

# Installation

As a subdirectory the main go-forgetop repository, you get it with
`go get github.com/forgetopchain/go-forgetop`.
